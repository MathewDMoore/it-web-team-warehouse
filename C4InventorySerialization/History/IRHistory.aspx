<%@ Page Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="IRHistory.aspx.cs" Inherits="C4InventorySerialization.Content.IRHistory" %>
...
<script type="text/javascript">
   ...
   <table width="100%"><tr>
   <td><div id="pgTitle">Inventory Request History</div></td><td><div id="loggedUser"></div></td>
   </tr></table>
   <hr />
    <asp:SqlDataSource ID="sds1" runat="server"
        ConnectionString="<%$ ConnectionStrings:InventoryConnectionString %>" SelectCommand="Select * from c4_goodsissue_ir_out where docnum = @DOCNUM" SelectCommandType="Text">
        <SelectParameters>
    ...
    ShowFooter="true" AllowSorting="true" PageSize="500"  ShowLoadingMessage="false" AllowMultiRecordEditing="false" AllowAddingRecords="false" Width="100%" FolderExports="../Exports">
            ...
            <ExportingSettings ExportDetails="true" FileName="IRHistory" ExportedFilesLifeTime="0" ExportedFilesTargetWindow="New" AppendTimeStamp="true" />
            ...
            <Columns>
                ...
                <obout:Column DataField="VERIFIEDBY" Visible="True" HeaderText="Verified By" ShowFilterCriterias="false" Index="3" Width="25%" ReadOnly="true">
                    <FilterOptions>
                        <obout:FilterOption Type="Contains" IsDefault="true" />
                    </FilterOptions>
                </obout:Column>
            ...
            <MasterDetailSettings LoadingMode="OnCallback" />
                <DetailGrids>
                    <obout:DetailGrid ID="DetailGrid1" runat="server" ForeignKeys="DOCNUM" DataSourceID="sds1" Serialize="false" Width="98%" AllowAddingRecords="false" AutoGenerateColumns="false" ShowLoadingMessage="true" AllowSorting="true" AllowGrouping="true">
                        <CssSettings CSSExportHeaderCellStyle="font-family: arial;font-weight: bold;background-color: #CCCCCC;color: black;" />
                        <Columns>
