<%@ Page Language="C#" MasterPageFile="~/Master/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="C4InventorySerialization.Content.Login" EnableSessionState="ReadOnly" %>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="submitName" class="btn btn-primary" onclick="SubmitContractorDetails()">Save changes</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
