            ...
            <div class="well" ng-show="scan.Delivery">
                <div id="deliveryHeader" class="well">
                    ...
                    <div class="right">
                        ...
                        <button class="btn btn-danger" id="clearDelivery">Clear Delivery</button>
                ...
                <div class="row">
                    ...
                    <div class="input-group" style="width: 328px">
                        <input class="form-control" ng-model="scan.SerialCodeLookUp" ng-change="scan.VerifyLineitem(scan.SerialCodeLookUp)" popover="Serial code not found" popover-title="Error" popover-placement="right" />
