...
<asp:Content ContentPlaceHolderID="Header" runat="server" ID="Header">
	...
	<script type="text/javascript">
		var app = angular.module("shipApp").config(BaseConfiguration);
		...
		<div ng-controller="ScanController as scan" class="well" ng-init="scan.Username='<%=User.Identity.Name %>'">
			...
			<form style="display: inline-block;" ng-submit="scan.LookUp(scan.OrderIdLookUp,scan.LookUpIsInternal)" <%=init %>>
				<div class="input-group" style="width: 300px;">
					...
					<span class="input-group-addon " style="cursor: pointer" ng-click="scan.LookUp(scan.OrderIdLookUp,scan.LookUpIsInternal)" id="loadDelivery">{{scan.IsSearching?'Loading...':'Load Delivery'}}</span>
				</div>
			...
			<div style="margin-top: 10px;" ng-if="scan.Delivery">
				<div class="panel panel-info">
					<div class="panel-heading">
						...
						<div style="float: right; position: relative; top: -5px;">
							<div class="btn-group">
								<button class="btn btn-lg btn-primary" ng-click="scan.ExportCSV()" ng-if="scan.Delivery.IsVerified">Export</button>
							</div>
						</div>
					</div>
				...
				<div ng-if="scan.ActiveKit" style="clear: both;">
					<h3><i class="fa fa-list-alt" style="margin-right: 5px;"></i>Current Kit - {{scan.ActiveKit[0].ItemCode}}</h3>
					<div>
