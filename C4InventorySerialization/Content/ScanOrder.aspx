            ...
            <div style="margin-top: 10px;" ng-if="scan.Delivery">
                ...
                <div style="float: left; margin-bottom: 20px;">
                    ...
                    <div class="input-group" style="width: 328px">
                        <input class="form-control" autofocus auto-select select="scan.SerialScanStatus.Select" ng-model="scan.SerialCodeLookUp" disable-me="scan.SavingItem" ng-change="scan.VerifyLineitem(scan.SerialCodeLookUp)" />
