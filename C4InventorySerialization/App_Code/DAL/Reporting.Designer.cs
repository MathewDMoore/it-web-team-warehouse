...
namespace C4InventorySerialization.App_Code.DAL {
    ...
    public partial class Reporting : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InventoryRow AddInventoryRow(int Year, int InventoryID) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InventoryRow FindByYearInventoryID(int Year, int InventoryID) {
...
namespace C4InventorySerialization.App_Code.DAL.ReportingTableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Inventory] WHERE (([Year] = @Original_Year) AND ([InventoryID]" +
            ...
            this._adapter.InsertCommand.CommandText = "\r\n\t\t\t\t\t\t\t\t\t\t\tINSERT INTO [dbo].[Inventory] ([Year], [InventoryID]) VALUES (@Year," +
                " @InventoryID);\r\n\t\t\t\t\t\t\t\t\t\t\tSELECT Year, InventoryID FROM Inventory WHERE (Inven" +
                "toryID = @InventoryID) AND (Year = @Year)\r\n\t\t\t\t\t\t\t\t\t\t";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Year, InventoryID FROM dbo.Inventory";
        ...
        public virtual int Fill(Reporting.InventoryDataTable dataTable) {
        ...
        public virtual Reporting.InventoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Reporting.InventoryDataTable dataTable = new Reporting.InventoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Reporting.InventoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Year, int Original_InventoryID) {
        ...
        public virtual int Insert(int Year, int InventoryID) {
        ...
        public virtual int Update(int Year, int InventoryID, int Original_Year, int Original_InventoryID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Original_Year, int Original_InventoryID) {
            return this.Update(Original_Year, Original_InventoryID, Original_Year, Original_InventoryID);
        }
    }
}
